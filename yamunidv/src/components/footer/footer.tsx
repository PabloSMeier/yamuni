...
export const Footer = () => {
  ...
  return (
    <footer className="bottom-0 w-full h-[10vh] py-4 px-2 z-50 static bg-white text-primary font-bold border-t-2 border-primaryB font-yk grid grid-cols-3 items-center justify-center">
